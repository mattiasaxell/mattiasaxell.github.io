...
en kort, enkel och pedagogisk ordlista:

## Interoperabilitet
Förmågan hos olika system, program eller organisationer att fungera tillsammans och utbyta information utan problem.
(Tänk: ”Alla pratar samma språk och förstår varandra direkt – ingen behöver en tolk.”)

## Länkade data (Linked Data)

Ett sätt att publicera och koppla ihop data på webben så att både människor och datorer lätt kan förstå och använda det.
Data får unika webbadresser (URI:er) och kopplas till varandra med tydliga relationer.
(Tänk: ”Istället för att data ligger i isolerade silos blir det som ett gigantiskt spindelnät där allt hänger ihop.”)

## Semantik

Betydelsen bakom orden och datan (inte bara texten eller siffrorna i sig, utan vad de egentligen betyder och hur de hänger ihop).
