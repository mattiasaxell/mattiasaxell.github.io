...
För att bygga ett verkligt motståndskraftigt Sverige bör vi istället titta på, använda och finansiera decentraliserade och federerade lösningar. Det finns idag moderna alternativ inom öppen källkod, exempelvis [Forgejo](https://forgejo.org/) (som även [nämns i rapporten](https://github.com/diggsweden/ena-samverkansplattform-os/tree/main?tab=readme-ov-file)), som möjliggör just detta. Till skillnad från en monolitisk lösning har [Forgejo](https://forgejo.org/) stöd för federering. Det innebär att varje myndighet själva eller med stöd av privat sektor, i egen IT-drift eller i molntjänst (leverantörers serverdatorer, EU-ägda och lokaliserade i EU) kan drifta sin egen instans. Detta med full kontroll över egen data och infrastruktur – samtidigt som de samarbetar sömlöst med andra i offentlig, privat eller civil sektor.

Genom federering och integration med svenska identitetsstrukturer som [Sweden Connect](https://swedenconnect.se/) (via Single Sign On), kan en utvecklare på [Skatteverket](https://www.skatteverket.se/) eller hos privat leverantör, bidra till kod hos [Försäkringskassan](https://www.forsakringskassan.se/) utan att skapa centrala beroenden. Om en myndighets nod attackeras, påverkas inte resten av det offentliga Sveriges utvecklingsförmåga. Det är digital suveränitet i praktiken. Möjligheten att spegla andra organisationers kod är också fördelaktig för redundans och samhällsberedskap - detta utöver självklara säkerhetskopior. Det ska helt enkelt inte gå att stänga ned Sverige.
...
Att välja en lösning som [Forgejo](https://forgejo.org/) eller motsvarande teknisk lösning som är öppen källkod med stöd för federering är därför inte bara en teknisk preferens – det är en säkerhetspolitisk nödvändighet. Utan de fyra friheterna så hyr vi bara vår suveränitet i andras infrastruktur. Med de fyra friheterna äger vi suveräniteten och har den på riktigt. 
...
- Bild: [Andrew Moca - Hands holding a paper chain](https://unsplash.com/photos/text-yAGNjU4rtss).
- Rapporten "Kodsamverkansplattform för öppen programvara – 1.0.0" finns att ta del av [här](/uploads/Digg-2025-07189-Arbetsgrupp-kodsamverkansplattform-för-öppen-programvara-Ena-1.0.0.pdf).