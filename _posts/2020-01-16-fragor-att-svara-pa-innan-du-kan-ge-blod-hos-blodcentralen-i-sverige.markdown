---
layout:     post
title:      "Frågor att svara på innan du kan ge blod hos Blodcentralen i Sverige"
...
Jag är blodgivare och kan rekommendera fler att ge blod. Det är trevligt, tar väldigt lite tid och räddar liv! Genom att kontrollera att du kan svara ärligt och korrekt på dessa frågor (dessa frågor gäller i alla fall för män) innan du åker till Blodcentralen kan du spara tid, kanske en omväg eller hel tur- och returresa till Blodcentralen. När du som blodgivare är där kommer du som vanligt att behöva svara på dem på plats sanningsenligt och därefter möjligen ge blod. Här är frågorna:
